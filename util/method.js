...
// ----------------------------check only number-----------------------------
function checkNumber(value,id,placeholder) {
    var regexNumber =  /^\d+$/;
    if(regexNumber.test(value)) {
       ...
       document.querySelector(`#${id}`).className = "block text-danger";
       document.querySelector(`#${id}`).innerHTML = `${placeholder} chỉ được nhập số`
       return false;
    }
   } 

// ------------------------check duplicated---------------------------
function checkDuplicated(value,id,placeholder) {
